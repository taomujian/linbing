...
&& yum install -y -q zlib-devel bzip2-devel openssl-devel ncurses-devel sqlite-devel readline-devel tk-devel make libffi-devel nmap masscan nginx -y initscripts postgresql-devel python3-devel uwsgi uwsgi-plugin-common redis \
