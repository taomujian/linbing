...
from app.dirsearch.lib.core import ArgumentParser
from app.dirsearch.lib.controller import Controller
from app.dirsearch.lib.output import CLIOutput, PrintOutput

class Program(object):
    def __init__(self, url):
        self.script_path = os.path.dirname(os.path.realpath(__file__))

        self.arguments = ArgumentParser(self.script_path, url)
