...
class Fofa_Scanner:
    ...
    def handle(self, header, body, title, key, name):
    ...
    def run(self):
        try:
            ...
            for item in self.fofa_finger_list:
                ...
                try:
                    self.handle(header, body, title, key, name)
                except Exception as e:
                    pass
        except Exception as e:
            print(e)
...
class WhatCms:
    ...
    def request_url(self, url):
        ...
        try:
            req = request.get(url = url, headers = self.requests_headers(), allow_redirects = False)
            self.num = self.num + 1
            req.encoding = 'utf-8'
