...
class CVE_2016_10134_BaseVerify:
    ...
    def run(self):
        ...
        try:
            check_req = requests.get(url, headers = self.headers, allow_redirects = False, verify=False)
            ...
            sql_req = requests.get(sql_url, headers = self.headers, allow_redirects = False, verify=False)
