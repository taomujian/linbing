...
from app.thirdparty.dirsearch.lib.utils.default_config_parser import DefaultConfigParser
from app.thirdparty.dirsearch.lib.utils.file_utils import File
from app.thirdparty.dirsearch.lib.utils.file_utils import FileUtils
from app.thirdparty.dirsearch.thirdparty.oset import oset


class ArgumentParser(object):
    def __init__(self, script_path, url):
